  ...
  Future<List<JSON>> getCategories() async {
    ...
    var categories = [
      ...
      },
      {
        ...
        'name': 'Shoes',
        'image':
            'https://images.unsplash.com/photo-1562183241-b937e95585b6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2265&q=80'
      },
      {
        'id': 10,
        'name': 'Jewelry',
        'image':
            'https://images.unsplash.com/photo-1625908733875-efa9c75c084d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2680&q=80'
      },
      {
        'id': 11,
        'name': 'Watches',
        'image':
            'https://images.unsplash.com/photo-1612817159623-0399784fd0ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2650&q=80'
      },
    ];
